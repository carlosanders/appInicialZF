...
(function ($) {
    ...
    function _2eb(_2ec, pp, _2ed) {
        ...
        _2ed = _2ed || {};
        pp.panel($.extend({}, _2ed, {
            border: false,
            noheader: true,
            closed: true,
            doSize: false,
            iconCls: (_2ed.icon ? _2ed.icon : undefined),
            onLoad: function () {
                if (_2ed.onLoad) {
    ...
    function _2f3(_2f4, _2f5) {
        ...
        pp.panel($.extend({}, _2f5.options, {
            iconCls: (_2f5.options.icon ? _2f5.options.icon : undefined)
        }));
        var opts = pp.panel("options");
        var tab = opts.tab;
    ...
    $.fn.tabs = function (_31f, _320) {
        ...
        return this.each(function () {
            ...
            if (_321) {
                ...
                $.data(this, "tabs", {
                    options: $.extend({}, $.fn.tabs.defaults, $.fn.tabs.parseOptions(this), _31f),
                    tabs: [],
                    selectHis: []
                });
                _2dd(this);
    ...
    $.fn.tabs.parseOptions = function (_32d) {
        return $.extend({}, $.parser.parseOptions(_32d, ["width", "height", "tools", "toolPosition", "tabPosition", {
            fit: "boolean",
            border: "boolean",
            plain: "boolean",
            headerWidth: "number",
...
(function ($) {
    ...
    function _350(_351, _352, el) {
        ...
        var _354 = $.extend({}, $.fn.layout.paneldefaults, {
    ...
    function _362(_363, _364, _365) {
        ...
        function _36a() {
            ...
            if (_364 == "east") {
                ...
                return {
                    resizeC: {
                        width: _36d.width + _36e.width - 28
                    },
                    expand: {
                        left: cc.width() - _36e.width
                    },
                    expandP: {
                        top: _36d.top,
                        left: cc.width() - 28,
                ...
                if (_364 == "west") {
                    ...
                    return {
                        resizeC: {
                            width: _36d.width + _36f.width - 28,
                            left: 28
                        },
                        expand: {
                            left: 0
                    ...
                    if (_364 == "north") {
                        ...
                        _366.east.panel("resize", {
                            top: 28,
                            height: hh
                        });
                        _366.west.panel("resize", {
                            top: 28,
                            height: hh
                        });
                        if (_34c(_366.expandEast)) {
                            _366.expandEast.panel("resize", {
                                top: 28,
                                height: hh
                            });
                        }
                        if (_34c(_366.expandWest)) {
                            _366.expandWest.panel("resize", {
                                top: 28,
                                height: hh
                            });
                        }
                        return {
                            ...
                            collapse: {
                                top: -_366["north"].panel("options").height,
                                width: cc.width()
                            }
                        };
                    } else {
                        if (_364 == "south") {
                            ...
                            return {
                                ...
                                expand: {
                                    top: cc.height() - _366["south"].panel("options").height
                                },
                                expandP: {
                                    top: cc.height() - 28,
                                    left: 0,
        ...
        function _375() {
            ...
            if (_372 == "east" && _373.expandEast) {
                return {
                    ...
                    expand: {
                        left: cc.width() - _373["east"].panel("options").width
                    }
                };
            } else {
                if (_372 == "west" && _373.expandWest) {
                    return {
                        collapse: {
                            left: -_373["west"].panel("options").width,
                            top: _377.top,
                            height: _377.height
                        },
                        expand: {
                    ...
                    if (_372 == "north" && _373.expandNorth) {
                        return {
                            collapse: {
                                top: -_373["north"].panel("options").height,
                                width: cc.width()
                            },
                            expand: {
                                top: 0
                        ...
                        if (_372 == "south" && _373.expandSouth) {
                            return {
                                ...
                                expand: {
                                    top: cc.height() - _373["south"].panel("options").height
                                }
                            };
                        }
                    }
    ...
    $.fn.layout.parseOptions = function (_383) {
        return $.extend({}, $.parser.parseOptions(_383, [{
            fit: "boolean"
        }]));
    };
    $.fn.layout.defaults = {
    ...
    $.fn.layout.parsePanelOptions = function (_384) {
        var t = $(_384);
        return $.extend({}, $.fn.panel.parseOptions(_384), $.parser.parseOptions(_384, ["region", {
            split: "boolean",
            minWidth: "number",
            minHeight: "number",
            maxWidth: "number",
...
(function ($) {
    function init(_385) {
        ...
        function _389(menu) {
            ...
            if (menu.hasClass("menu-content")) {
                ...
                menu.children("div").each(function () {
                    var item = $(this);
                    var _38d = $.extend({}, $.parser.parseOptions(this, ["name", "iconCls", "href", {
                        separator: "boolean"
                    }]), {
    ...
    $.fn.menu = function (_3b3, _3b4) {
        ...
        return this.each(function () {
            ...
            if (_3b5) {
                ...
                _3b5 = $.data(this, "menu", {
                    options: $.extend({}, $.fn.menu.defaults, $.fn.menu.parseOptions(this), _3b3)
                });
                init(this);
            }
            $(this).css({
                left: _3b5.options.left,
                top: _3b5.options.top
            });
        });
    };
    $.fn.menu.methods = {
    ...
    $.fn.menu.parseOptions = function (_3bd) {
        return $.extend({}, $.parser.parseOptions(_3bd, ["left", "top", {
            minWidth: "number",
...
(function ($) {
        ...
        return this.each(function () {
            ...
            if (_3cd) {
                ...
                $.data(this, "menubutton", {
                    options: $.extend({}, $.fn.menubutton.defaults, $.fn.menubutton.parseOptions(this), _3ca)
                });
                $(this).removeAttr("disabled");
            }
            init(this);
    ...
    $.fn.menubutton.parseOptions = function (_3d0) {
        var t = $(_3d0);
        return $.extend({}, $.fn.linkbutton.parseOptions(_3d0), $.parser.parseOptions(_3d0, ["menu", {
            plain: "boolean",
            duration: "number"
        }]));
    };
...
(function ($) {
        ...
        return this.each(function () {
            ...
            if (_3d5) {
                ...
                $.data(this, "splitbutton", {
                    options: $.extend({}, $.fn.splitbutton.defaults, $.fn.splitbutton.parseOptions(this), _3d2)
                });
                $(this).removeAttr("disabled");
            }
            init(this);
    ...
    $.fn.splitbutton.methods = {
        options: function (jq) {
            ...
            $.extend(_3d7, {
                disabled: _3d6.disabled,
                toggle: _3d6.toggle,
                selected: _3d6.selected
            });
            return _3d7;
        }
    };
    $.fn.splitbutton.parseOptions = function (_3d8) {
        var t = $(_3d8);
        return $.extend({}, $.fn.linkbutton.parseOptions(_3d8), $.parser.parseOptions(_3d8, ["menu", {
            plain: "boolean",
            duration: "number"
        }]));
    };
...
(function ($) {
    ...
    function _3db(_3dc, _3dd) {
        ...
        _3e0.find("span.l-btn-text,span.m-btn-downarrow").css({
            height: _3e0.height() + "px",
            lineHeight: _3e0.height() + "px"
        });
        sb.insertAfter(_3dc);
    };
    ...
    function _3e1(_3e2) {
        ...
        function _3e4(item) {
            ...
            mb.prependTo(_3e3.searchbox).menubutton({
                menu: _3e3.menu,
                iconCls: item.iconCls
            });
    ...
    $.fn.searchbox = function (_3ef, _3f0) {
        ...
        return this.each(function () {
            ...
            if (_3f1) {
                ...
                _3f1 = $.data(this, "searchbox", {
                    options: $.extend({}, $.fn.searchbox.defaults, $.fn.searchbox.parseOptions(this), _3ef),
                    searchbox: init(this)
                });
            }
            _3e1(this);
    ...
    $.fn.searchbox.parseOptions = function (_3f4) {
        var t = $(_3f4);
        return $.extend({}, $.parser.parseOptions(_3f4, ["width", "height", "prompt", "menu"]), {
            value: t.val(),
...
(function ($) {
    ...
    function _3fe(_3ff) {
        ...
        $(_3ff).tooltip($.extend({}, opts.tipOptions, {
            content: _400.message,
        ...
        return this.each(function () {
            ...
            if (_415) {
                ...
                $.data(this, "validatebox", {
                    options: $.extend({}, $.fn.validatebox.defaults, $.fn.validatebox.parseOptions(this), _413)
                });
            }
            _410(this);
            _406(this);
    ...
    $.fn.validatebox.parseOptions = function (_416) {
        var t = $(_416);
        return $.extend({}, $.parser.parseOptions(_416, ["validType", "missingMessage", "invalidMessage", "tipPosition", {
            delay: "number",
            deltaX: "number"
        }]), {
...
(function ($) {
    function _41e(_41f, _420) {
        ...
        var _423 = $("<iframe id=" + _422 + " name=" + _422 + "></iframe>").attr("src", window.ActiveXObject ? "javascript:false" : "about:blank").css({
            position: "absolute",
            top: -1000,
            left: -1000
        });
    ...
    $.fn.form = function (_43f, _440) {
        ...
        return this.each(function () {
            if (!$.data(this, "form")) {
                $.data(this, "form", {
                    options: $.extend({}, $.fn.form.defaults, _43f)
                });
            }
            _437(this);
        });
...
(function ($) {
    ...
    $.fn.numberbox = function (_455, _456) {
        ...
        return this.each(function () {
            ...
            if (_458) {
                ...
                _458 = $.data(this, "numberbox", {
                    options: $.extend({}, $.fn.numberbox.defaults, $.fn.numberbox.parseOptions(this), _455),
                    field: init(this)
                });
                $(this).removeAttr("disabled");
                $(this).css({
    ...
    $.fn.numberbox.parseOptions = function (_45b) {
        var t = $(_45b);
        return $.extend({}, $.fn.validatebox.parseOptions(_45b), $.parser.parseOptions(_45b, ["decimalSeparator", "groupSeparator", "suffix", {
            min: "number",
            max: "number",
            precision: "number"
        }]), {
...
(function ($) {
    ...
    $.fn.calendar = function (_481, _482) {
        ...
        return this.each(function () {
            ...
            if (_483) {
                ...
                _483 = $.data(this, "calendar", {
                    options: $.extend({}, $.fn.calendar.defaults, $.fn.calendar.parseOptions(this), _481)
                });
                init(this);
            }
    ...
    $.fn.calendar.parseOptions = function (_484) {
        var t = $(_484);
        return $.extend({}, $.parser.parseOptions(_484, ["width", "height", {
            firstDay: "number",
            fit: "boolean",
            border: "boolean"
        }]));
...
(function ($) {
    ...
    function _487(_488, _489) {
        ...
        $(_488).css({
            height: _48a.height() + "px",
            lineHeight: _48a.height() + "px"
        });
    ...
    $.fn.spinner = function (_493, _494) {
        ...
        return this.each(function () {
            ...
            if (_496) {
                ...
                _496 = $.data(this, "spinner", {
                    options: $.extend({}, $.fn.spinner.defaults, $.fn.spinner.parseOptions(this), _493),
                    spinner: init(this)
                });
                $(this).removeAttr("disabled");
            }
    ...
    $.fn.spinner.parseOptions = function (_49a) {
        var t = $(_49a);
        return $.extend({}, $.fn.validatebox.parseOptions(_49a), $.parser.parseOptions(_49a, ["width", "height", "min", "max", {
            increment: "number",
            editable: "boolean"
        }]), {
            value: (t.val() || undefined),
        ...
        return this.each(function () {
            ...
            if (_4a2) {
                ...
                $.data(this, "numberspinner", {
                    options: $.extend({}, $.fn.numberspinner.defaults, $.fn.numberspinner.parseOptions(this), _49f)
                });
            }
            _49b(this);
        });
...
(function ($) {
        ...
        return this.each(function () {
            ...
            if (_4bc) {
                ...
                $.data(this, "timespinner", {
                    options: $.extend({}, $.fn.timespinner.defaults, $.fn.timespinner.parseOptions(this), _4b9)
                });
                _4a5(this);
            }
        });
    ...
    $.fn.timespinner.parseOptions = function (_4be) {
        return $.extend({}, $.fn.spinner.parseOptions(_4be), $.parser.parseOptions(_4be, ["separator", {
            showSeconds: "boolean",
            highlight: "number"
        }]));
    };
...
(function ($) {
    ...
    function _4d5(_4d6) {
        ...
        if (opts.height != "auto") {
            ...
            _4d9.add(_4da).children("div.datagrid-body").css({
                marginTop: _4e1,
                height: (_4e0 - _4e1)
            });
        }
    ...
    function _4f6(_4f7, _4f8) {
        ...
        return {
            ...
            dc: {
                ...
                view1: _4ff,
                view2: _500,
                header1: _4ff.children("div.datagrid-header").children("div.datagrid-header-inner"),
                header2: _500.children("div.datagrid-header").children("div.datagrid-header-inner"),
                body1: _4ff.children("div.datagrid-body").children("div.datagrid-body-inner"),
                body2: _500.children("div.datagrid-body"),
                footer1: _4ff.children("div.datagrid-footer").children("div.datagrid-footer-inner"),
                footer2: _500.children("div.datagrid-footer").children("div.datagrid-footer-inner")
            },
            ss: ss
        };
    };
    ...
    function _502(_503) {
        ...
        var dc = _504.dc;
        var _505 = _504.panel;
        _505.panel($.extend({}, opts, {
            id: null,
            doSize: false,
            onResize: function (_506, _507) {
                setTimeout(function () {
        ...
        if (opts.pagination) {
            ...
            _50a.pagination({
                ...
                onSelectPage: function (_50b, _50c) {
                    opts.pageNumber = _50b;
                    opts.pageSize = _50c;
                    _50a.pagination("refresh", {
                        pageNumber: _50b,
                        pageSize: _50c
                    });
                    _5f2(_503);
        ...
        _51b.each(function () {
            $(this).resizable({
                ...
                onStartResize: function (e) {
                    ...
                    _518.proxy.css({
                        left: e.pageX - $(_519).offset().left - 1,
                        display: "none"
                    });
                    setTimeout(function () {
                        if (_518.proxy) {
    ...
    function _514(_553, _554) {
        ...
        var _555 = (_554 == true) ? (opts.frozenColumns || [
            []
        ]) : opts.columns;
        if (_555.length == 0) {
            return [];
            ...
            if (col && col.editor) {
                ...
                if (_5c3) {
                    ...
                    $.data(cell[0], "datagrid.editor", {
                        actions: _5c3,
                        target: _5c3.init(cell.find("td"), _5c2),
                        field: _5c0,
                        type: _5c1,
                        oldHtml: _5c4
                    });
    ...
    function _5d1(_5d2, _5d3) {
        ...
        $(_5d2).datagrid("getPager").pagination("refresh", {
            total: data.total
        });
    };
    ...
    function _5d7(_5d8, _5d9) {
        ...
        _5da.push(_5d9.row);
        $(_5d8).datagrid("getPager").pagination("refresh", {
            total: data.total
        });
    };
    ...
    function _5db(_5dc, row) {
        ...
        _5dd.push(row);
        $(_5dc).datagrid("getPager").pagination("refresh", {
            total: data.total
        });
    };
        ...
        return this.each(function () {
            ...
            if (_5fe) {
                ...
                opts = $.extend({}, $.extend({}, $.fn.datagrid.defaults, {
                    queryParams: {}
                }), $.fn.datagrid.parseOptions(this), _5fc);
    ...
    $.fn.datagrid.methods = {
        options: function (jq) {
            ...
            var opts = $.extend(_645, {
                width: _646.width,
                height: _646.height,
                closed: _646.closed,
                collapsed: _646.collapsed,
                minimized: _646.minimized,
                maximized: _646.maximized
            });
            return opts;
        },
    ...
    $.fn.datagrid.parseOptions = function (_66d) {
        var t = $(_66d);
        return $.extend({}, $.fn.panel.parseOptions(_66d), $.parser.parseOptions(_66d, ["url", "toolbar", "idField", "sortName", "sortOrder", "pagePosition", "resizeHandle", {
            fitColumns: "boolean",
    ...
    var _670 = {
        render: function (_671, _672, _673) {
    ...
    $.fn.datagrid.defaults = $.extend({}, $.fn.panel.defaults, {
        ...
        editors: _600,
        finder: {
            getTr: function (_6b0, _6b1, type, _6b2) {
                type = type || "body";
                _6b2 = _6b2 || 0;
...
(function ($) {
    ...
    function _6d7(_6d8) {
        ...
        $(_6d8).datagrid($.extend({}, opts, {
            cls: "propertygrid",
            view: (opts.showGroup ? _6da : undefined),
            onClickRow: function (_6db, row) {
                if (_6d6 != this) {
                    _6dc(_6d6);
                    _6d6 = this;
                }
    ...
    $.fn.propertygrid.parseOptions = function (_6e3) {
        var t = $(_6e3);
        return $.extend({}, $.fn.datagrid.parseOptions(_6e3), $.parser.parseOptions(_6e3, [{
            showGroup: "boolean"
        }]));
    };
    var _6da = $.extend({}, $.fn.datagrid.defaults.view, {
        render: function (_6e4, _6e5, _6e6) {
    ...
    $.fn.propertygrid.defaults = $.extend({}, $.fn.datagrid.defaults, {
        ...
        showGroup: false,
        groupField: "group",
        groupFormatter: function (_702, rows) {
            return _702;
        }
    });
})(jQuery);
(function ($) {
    function _703(_704) {
        ...
        if (opts.pagination) {
            ...
            _719.pagination({
                ...
                pageSize: opts.pageSize,
                pageList: opts.pageList,
                onSelectPage: function (_71a, _71b) {
    ...
    function _776(_777, _778) {
        ...
        _772(_777, {
            parent: (_779 ? _779[opts.idField] : null),
            data: [_778.data]
        });
        _77a(true);
        _77a(false);
    ...
    $.fn.treegrid = function (_783, _784) {
        ...
        return this.each(function () {
            ...
            if (_786) {
                ...
                _786 = $.data(this, "treegrid", {
                    options: $.extend({}, $.fn.treegrid.defaults, $.fn.treegrid.parseOptions(this), _783),
                    data: []
                });
            }
            _703(this);
    ...
    $.fn.treegrid.parseOptions = function (_78f) {
        return $.extend({}, $.fn.datagrid.parseOptions(_78f), $.parser.parseOptions(_78f, ["treeField", {
            animate: "boolean"
        }]));
    };
    var _790 = $.extend({}, $.fn.datagrid.defaults.view, {
    ...
    $.fn.treegrid.defaults = $.extend({}, $.fn.datagrid.defaults, {
        ...
        singleSelect: true,
        view: _790,
        loader: function (_7c7, _7c8, _7c9) {
            var opts = $(this).treegrid("options");
            if (!opts.url) {
                return false;
            }
        ...
        finder: {
            getTr: function (_7cb, id, type, _7cc) {
                type = type || "body";
                _7cc = _7cc || 0;
...
(function ($) {
    function _7d2(_7d3, _7d4) {
        ...
        _7d8.css({
            height: _7d6.height() + "px",
            lineHeight: _7d6.height() + "px"
        });
        _7d9._outerHeight(_7d6.height());
        _7d7.panel("resize", {
            width: (opts.panelWidth ? opts.panelWidth : _7d6.outerWidth()),
    ...
    $.fn.combo = function (_81e, _81f) {
        ...
        return this.each(function () {
            ...
            if (_822) {
                ...
                var r = init(this);
                _822 = $.data(this, "combo", {
                    options: $.extend({}, $.fn.combo.defaults, $.fn.combo.parseOptions(this), _81e),
                    combo: r.combo,
                    panel: r.panel,
                    previousValue: null
                });
    ...
    $.fn.combo.parseOptions = function (_827) {
        var t = $(_827);
        return $.extend({}, $.fn.validatebox.parseOptions(_827), $.parser.parseOptions(_827, ["width", "height", "separator", {
            panelWidth: "number",
            editable: "boolean",
    ...
    $.fn.combobox = function (_859, _85a) {
        ...
        return this.each(function () {
            ...
            if (_85c) {
                ...
                _85c = $.data(this, "combobox", {
                    options: $.extend({}, $.fn.combobox.defaults, $.fn.combobox.parseOptions(this), _859),
                    data: []
                });
                _856(this);
    ...
    $.fn.combobox.methods = {
        options: function (jq) {
            ...
            return $.extend($.data(jq[0], "combobox").options, {
                originalValue: _85d.originalValue,
                disabled: _85d.disabled,
                readonly: _85d.readonly
            });
        },
        getData: function (jq) {
    ...
    $.fn.combotree = function (_87b, _87c) {
        ...
        return this.each(function () {
            ...
            if (_87e) {
                ...
                $.data(this, "combotree", {
                    options: $.extend({}, $.fn.combotree.defaults, $.fn.combotree.parseOptions(this), _87b)
                });
            }
            _86f(this);
        });
    ...
    $.fn.combotree.methods = {
        options: function (jq) {
            ...
            return $.extend($.data(jq[0], "combotree").options, {
                originalValue: _87f.originalValue,
                disabled: _87f.disabled,
                readonly: _87f.readonly
            });
        },
        tree: function (jq) {
    ...
    $.fn.combogrid = function (_8a2, _8a3) {
        ...
        return this.each(function () {
            ...
            if (_8a5) {
                ...
                _8a5 = $.data(this, "combogrid", {
                    options: $.extend({}, $.fn.combogrid.defaults, $.fn.combogrid.parseOptions(this), _8a2)
                });
            }
            _883(this);
        });
...
(function ($) {
    function _8aa(_8ab) {
        ...
        $(_8ab).addClass("datebox-f").combo($.extend({}, opts, {
            onShowPanel: function () {
                _8ad();
    ...
    $.fn.datebox = function (_8c0, _8c1) {
        ...
        return this.each(function () {
            ...
            if (_8c3) {
                ...
                $.data(this, "datebox", {
                    options: $.extend({}, $.fn.datebox.defaults, $.fn.datebox.parseOptions(this), _8c0)
                });
            }
            _8aa(this);
        });
    ...
    $.fn.datebox.methods = {
        options: function (jq) {
            ...
            return $.extend($.data(jq[0], "datebox").options, {
                originalValue: _8c4.originalValue,
                disabled: _8c4.disabled,
                readonly: _8c4.readonly
            });
        },
...
(function ($) {
    function _8c7(_8c8) {
        ...
        $(_8c8).datebox("calendar").calendar({
            onSelect: function (date) {
        ...
        return this.each(function () {
            ...
            if (_8dd) {
                ...
                $.data(this, "datetimebox", {
                    options: $.extend({}, $.fn.datetimebox.defaults, $.fn.datetimebox.parseOptions(this), _8da)
                });
            }
            _8c7(this);
        });
    ...
    $.fn.datetimebox.methods = {
        options: function (jq) {
            ...
            return $.extend($.data(jq[0], "datetimebox").options, {
                originalValue: _8de.originalValue,
                disabled: _8de.disabled,
                readonly: _8de.readonly
            });
        },
        spinner: function (jq) {
    ...
    $.fn.datetimebox.parseOptions = function (_8e0) {
        var t = $(_8e0);
        return $.extend({}, $.fn.datebox.parseOptions(_8e0), $.parser.parseOptions(_8e0, ["timeSeparator", {
            showSeconds: "boolean"
        }]));
    };
...
(function ($) {
    ...
    function _8f6(_8f7) {
        ...
        _8f9.find("a.slider-handle").draggable({
            axis: opts.mode,
            cursor: "pointer",
    ...
    $.fn.slider = function (_912, _913) {
        ...
        return this.each(function () {
            ...
            if (_914) {
                ...
                _914 = $.data(this, "slider", {
                    options: $.extend({}, $.fn.slider.defaults, $.fn.slider.parseOptions(this), _912),
                    slider: init(this)
                });
                $(this).removeAttr("disabled");
            }
    ...
    $.fn.slider.parseOptions = function (_917) {
        var t = $(_917);
        return $.extend({}, $.parser.parseOptions(_917, ["width", "height", "mode", {
            reversed: "boolean",
            showTip: "boolean",
            min: "number",
            max: "number",
